 ...
 */
function monit_post_author($post) {
 ...
 * @param array $post is a post returned by wp_get_recent_posts()
 */
function monit_post_categories($post) {
    $categories = array();
...
function monit_post_tags_object($post) {
 ...
 * @param array $post is a post returned by wp_get_recent_posts()
 */
function monit_post_comment_info($post) {
    return array(
 ...
 */
function monit_post_thumb($post, $params) {
    $thumbs = array();
 ...
 * @param array $post is a post returned by wp_get_recent_posts
 */
function monit_post_content($post) {
 ...
 * @param array $post is a post returned by wp_get_recent_posts
 */
function monit_post_excerpt($post) {
    $excerpt = $post['post_excerpt'];
    if (empty($excerpt)) {
        $content = strip_tags(monit_post_content($post));
